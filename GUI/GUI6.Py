...
from pathlib import Path
from tkinter import Tk, Canvas, Entry, PhotoImage, scrolledtext
...
entry_1.insert(0, "Search Recipe")  # Placeholder text
entry_1.place(
    x=202.0,
    y=104.0,
    width=877.0,
...
results_text = scrolledtext.ScrolledText(window, width=80, height=20, wrap="word")
results_text.place(
    x=202.0,
    y=188.0,
    width=877.0,
...
canvas.create_text(
    ...
    fill="#000000",
    font=("BonheurRoyale Regular", 36 * -1, "italic")
