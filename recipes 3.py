...
def search_meal_by_name(meal_name):
    ...
    if response.status_code == 200:
        ...
        print(f"API request failed with status code: {response.status_code}")  # Debug print
        return None
...
def parse_user_input(user_input):
    ...
    print(f"Original input: '{user_input}'")  # Debug print
    print(f"Parsed meal name: '{meal_name}'")  # Debug print
